...
const DriverInfoScreen = ({ navigation }) => {
  ...
  const [driverInfoLayout, setDriverInfoLayout] = useState({
    width: 0,
    height: 0,
  });
  const [driverIntroTextLayout, setDriverIntroTextLayout] = useState({
    width: 0,
    height: 0,
  });
  const [driverImgLayout, setDriverImgLayout] = useState(null);
  const [driverFavLayout, setDriverFavLayout] = useState({
    width: 0,
    height: 0,
  });
  const [lastSeqeunceTxtLayout, setLastSequenceTxtLayout] = useState({
    width: 0,
    height: 0,
  });
  ...
  const resolveWeatherIcon = () => {
    if (weatherIconDictionary[weatherData.icon].iconFamily === "FontAwesome5") {
      return (
        <FontAwesome5
          name={weatherIconDictionary[weatherData.icon].icon}
          size={hp("14%")}
          color="white"
        />
      );
    } else if (
      weatherIconDictionary[weatherData.icon].iconFamily === "Ionicons"
    ) {
      return (
        <Ionicons
          name={weatherIconDictionary[weatherData.icon].icon}
      ...
      weatherIconDictionary[weatherData.icon].iconFamily === "Fontisto"
    ) {
      return (
        <Fontisto
          name={weatherIconDictionary[weatherData.icon].icon}
        ...
        <Animated.Image
          ...
          style={[
            styles.driverImage,
            {
              ...
              top: driverImageTop,
              left: driverImageLeft,
              transform: [{ scale: driverImageScale }],
            },
          ]}
        />
      </Animated.View>
        ...
        <Animated.View
          style={[
            styles.weatherView,
            {
              ...
              transform: [{ translateY: weatherViewTranslateY }],
            },
          ]}
        >
