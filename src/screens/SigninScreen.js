...
const SigninScreen = () => {
  ...
  useEffect(() => {
    ...
    if (error) {
      Alert.alert(
        "Signin Error",
        "This was an error signing in, make sure you are entering the correct details and try again",
        [
          {
            text: "Try Again",
            onPress: () => {
    ...
    >
      ...
      <View style={styles.signinContainer}>
        ...
        <CustomInput
          ...
          validationError={
            validationError.email && validationError.email.length > 0
        ...
        <CustomInput
          ...
          secure={true}
          validationError={
            validationError.password && validationError.password.length > 0
