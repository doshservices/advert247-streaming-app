    ...
    <View style={styles.backgroundStyle}>
      <View style={styles.resultBox}>
        ...
        <Text style={styles.result}>
          {answeredCorrectly} / {questionNumber}
        </Text>
        <Text style={styles.points}>{point} points</Text>
        <Text style={styles.resultText}>
          You got {answeredCorrectly} questions correctly out of{" "}
          {questionNumber} total questions, and you have a total point of{" "}
          {point}. You might just be the lucky winner, if you are our winner
